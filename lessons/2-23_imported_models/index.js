...
import { traverseMaterials } from './utils/traverse.js'

console.log(111, traverseMaterials);
...
// Megan - Binary
const meganModel = './static/models/Megan/Megan.glb'

// Duck - many types!
const duckModelglTF = './static/models/Duck/glTF/Duck.gltf'
const duckModelBinary = './static/models/Duck/glTF-Binary/Duck.glb'
const duckModelDraco = './static/models/Duck/glTF-Draco/Duck.gltf' // Need Draco loader!
const duckModelEmbedded = './static/models/Duck/glTF-Embedded/Duck.gltf'

// Helmet - glTF
const helmetModel = './static/models/FlightHelmet/glTF/FlightHelmet.gltf'

// Fox - many types!
const foxModelglTF = './static/models/Fox/glTF/Fox.gltf'
const foxModelBinary = './static/models/Fox/glTF-Binary/Fox.glb'
const foxModelDraco = './static/models/Fox/glTF-Draco/Fox.gltf' // Need Draco loader!
const foxModelEmbedded = './static/models/Fox/glTF-Embedded/Fox.gltf'
